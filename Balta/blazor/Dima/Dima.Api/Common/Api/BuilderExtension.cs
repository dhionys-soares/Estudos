...
namespace Dima.Api.Common.Api
{
    public static class BuilderExtension
    {
        ...
        {
            builder.Services.AddCors(c => c.AddPolicy(ApiConfiguration.CorPoliceName, p => p.WithOrigins([Configuration.BackendUrl, Configuration.FrontendUrl]).AllowAnyMethod().AllowAnyHeader().AllowCredentials()));
        }
    }
}
